...
export default function App() {
  ...
  const renderPage = () => {
    switch (page) {
      ...
      case 'create-ddh':   return <CreateDDH  sellers={sellers} customers={customers} contracts={contracts} onSave={saveContract} setPage={setPage} isAdmin={isAdmin} profile={profile} saleProfiles={saleProfiles} invoiceGoods={invoiceGoods} onCreateCustomer={saveCustomer} />;
      case 'create-bbbg':  return <CreateBBBG sellers={sellers} customers={customers} contracts={contracts} onSave={saveContract} setPage={setPage} isAdmin={isAdmin} profile={profile} saleProfiles={saleProfiles} invoiceGoods={invoiceGoods} onCreateCustomer={saveCustomer} />;
      ...
      case 'edit-ddh':     return <CreateDDH  sellers={sellers} customers={customers} contracts={contracts} onSave={saveContract} setPage={setPage} isAdmin={isAdmin} profile={profile} saleProfiles={saleProfiles} invoiceGoods={invoiceGoods} onCreateCustomer={saveCustomer} editData={editContractData} />;
      case 'edit-bbbg':    return <CreateBBBG sellers={sellers} customers={customers} contracts={contracts} onSave={saveContract} setPage={setPage} isAdmin={isAdmin} profile={profile} saleProfiles={saleProfiles} invoiceGoods={invoiceGoods} onCreateCustomer={saveCustomer} editData={editContractData} />;
